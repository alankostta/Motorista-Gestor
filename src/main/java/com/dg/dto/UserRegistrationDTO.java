...
public class UserRegistrationDTO {
    ...
    public UserRegistrationDTO(Long id,Role role, String fullName, String email, String password, String profilePhoto, LocalDateTime createdDate, LocalDateTime updatedDate) {
    	this.id = id;
    	this.role = role;
