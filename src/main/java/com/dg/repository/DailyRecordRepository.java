...
public interface DailyRecordRepository extends JpaRepository<DailyRecord, Long> {
    ...
    @Query("SELECT SUM(dr.fuelCost + dr.foodCost + dr.maintenanceCost + dr.otherCosts) FROM DailyRecord dr WHERE dr.user.id = :userId AND MONTH(dr.date) = :month AND YEAR(dr.date) = :year")
